...
;(function() {
  ...
  var util = (Crypto.util = {
    ...
    rotl: function(n: any, b: any) {
      return (n << b) | (n >>> (32 - b))
    },

    // Bit-wise rotate right
    rotr: function(n: any, b: any) {
      return (n << (32 - b)) | (n >>> b)
    },

    // Swap big-endian to little-endian and vice versa
    endian: function(n: any) {
    ...
    randomBytes: function(n: any) {
      for (var bytes = []; n > 0; n--) bytes.push(Math.floor(Math.random() * 256))
      return bytes
    },

    // Convert a string to a byte array
    stringToBytes: function(str: any) {
      var bytes = []
    ...
    stringToWords: function(str: any) {
      var words: any[] = []
    ...
    bytesToWords: function(bytes: any) {
      var words: any[] = []
    ...
    wordsToBytes: function(words: any) {
      var bytes = []
    ...
    bytesToBase64: function(bytes: any) {
    ...
    base64ToBytes: function(base64: any) {
      // Use browser-native function if it exists
